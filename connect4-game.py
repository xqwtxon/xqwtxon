...
def update_top_moves(user):
    ...
    with open('Data/Connect4/top_moves.txt', 'r') as file:
        contents = file.read()
    ...
    with open('Data/Connect4/top_moves.txt', 'w') as file:
        file.write(str(dictionary))


def update_last_moves(line):
    """Adds the given line to the last moves file"""
    with open('Data/Connect4/last_moves.txt', 'r+') as last_moves:
...
def main(issue, issue_author, repo_owner):
    ...
    if action[0] == Action.NEW_GAME:
        ...
        with open('Data/Connect4/last_moves.txt', 'w') as last_moves:
        ...
        with open('Data/Connect4/last_moves.txt') as moves:
            line = moves.readline()
